...
<body>
	<div class="container-fluid">
		...
		<div class="row flex-nowrap main-block">
			<div class="col-xs-8">
				<lucene:search lucenePath="/Users/eichmann/Documents/Components/n3c_index" label="content" queryParserName="standard" queryString="${param.query}" useConjunctionByDefault="true">
							<div id="results-box">
